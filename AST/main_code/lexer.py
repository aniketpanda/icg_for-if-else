...
tokens=['PRINT','PRINTF','CHAR','INT','FLOAT','PLUS','MINUS','NUMBER','AOP','RELOP','ID','ASSIGN','LOGOP','OPBRAC','CLOSEBRAC','STRLIT','STATETER','COMMA','OPENFLR','CLOSEFLR']+list(reserved.values())
symbol_table={}
